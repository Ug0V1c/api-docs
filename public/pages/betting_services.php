        ...
        <main class="flex-1 min-w-0 lg:ml-80">
            <div class="max-w-4xl mx-auto p-6 lg:p-8">
                ...
                <div class="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                    ...
                    <i :class="betting_services_icon + ' text-accent text-sm'"></i>

                    <span class="text-foreground dark:text-black font-medium">Betting Services</span>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-lg text-muted-foreground leading-relaxed">
                        This service enables funding of a <strong>betting account 🎲</strong> across multiple betting providers 💳.
                    </p>
