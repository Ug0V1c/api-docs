        ...
        <div class="max-w-4xl mx-auto p-6 lg:p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-lg text-muted-foreground leading-relaxed">
                    This document gives an overview of the Creditswitch low balance service. This is a subscription based service that enables customer to top up their balance while making calls . For technical assistance with the CSW API contact us at techsupport@creditswitch.com to enable swift response and support.
                </p>
            ...
            <div class="mb-8">
                ...
                <p class="text-lg text-muted-foreground leading-relaxed mb-2">
                    1) Onboarding: Begin by authenticating through the onboard Endpoint to retrieve a token for subsequent API calls.</p>
                    <p class="text-lg text-muted-foreground leading-relaxed mb-2">2) Subscription: Call the Auto Top up subscription Endpoint with the specified payload. This step allows user to subscribe to the service.</p>
                    <p class="text-lg text-muted-foreground leading-relaxed mb-2">3) Unsubscribe: If the customer wishes to unsubscribe from the Low Balance service, Call the unsubscribe endpoint to cancel active subscription.</p>
                    ...
                    <div class="grid gap-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="mt-1 p-3 bg-muted rounded-lg font-mono text-sm overflow-x-auto">baseUrl/api/v1/low/balance/create/vendor
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr class="border-b border-border">
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">Merchant debit callback Url</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">Merchant account callback Url</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr class="border-b border-border">
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">Corresponding description for the status.</td>
                                </tr>
                                <tr>
                            ...
                            <pre class="text-sm font-mono text-card-foreground overflow-x-auto" x-ref="sampleResponse">
{
    ...
    <span class="text-green-400">"statusDescription"</span>: <span class="text-green-400">"Account created successfully"</span>,
    <span class="text-green-400">"data"</span>: <span class="text-green-400">"srUNEuasfbs_UtcuwJHIVWO-euJHCHVcggfw"</span>
}
                            </pre>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <div class="grid gap-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="text-sm font-medium text-muted-foreground">Request URL</label>
                                <div class="mt-1 p-3 bg-muted rounded-lg font-mono text-sm overflow-x-auto">baseUrl/api/v1/low/balance/subscribe
                                </div>
                            </div>
                            <div>
                                <label class="text-sm font-medium text-muted-foreground">HTTP Method</label>
            ...
            <div class="bg-card border border-border rounded-lg mb-8" x-data="{ tab: 'sample' }">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr class="border-b border-border">
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">airtime threshold at which service should trigger</td>
                                </tr>
                                <tr class="border-b border-border">
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">data threshold at which service should trigger</td>
                                </tr>
                                <tr class="border-b border-border">
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">trigger type weather for airtime or data</td>
                                </tr>
                                <tr class="border-b border-border">
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">customers msisdn network provider</td>
                                </tr>
                                <tr>
                ...
                <div x-show="tab==='response'" class="bg-card border border-border rounded-lg mb-8">
                    ...
                    <div class="p-6">
                        <div class="bg-card p-4 rounded-lg border">
                            <pre class="text-sm font-mono text-card-foreground overflow-x-auto" x-ref="sampleResponse">
{ <span class="text-green-400">"network"</span>: <span class="text-green-400">"MTN"</span>, <span class="text-green-400">"product"</span>: <span class="text-green-400">"airtime"</span>, <span class="text-green-400">"airtimeThreshold"</span>: <span class="text-green-400">"200"</span>, <span class="text-green-400">"dataThreshold"</span>: <span class="text-green-400">"500MB"</span>, <span class="text-green-400">"amount"</span>: 
<span class="text-green-400">"100"</span>, <span class="text-green-400">"msisdn"</span>: <span class="text-green-400">"string"</span>, <span class="text-green-400">"createdAt"</span>: <span class="text-green-400">"2025-07-18T18:37:12.779576"</span> }
                            </pre>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="grid gap-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="text-sm font-medium text-muted-foreground">Request URL</label>
                                <div class="mt-1 p-3 bg-muted rounded-lg font-mono text-sm overflow-x-auto">baseUrl/api/v1/low/balance/{{msisdn}}/{{thresholdType}}/unsubscrible
                                </div>
                            </div>
                            <div>
                                <label class="text-sm font-medium text-muted-foreground">HTTP Method</label>
                            ...
                            <div>
                                <label class="text-sm font-medium text-muted-foreground">Request Headers</label>
                                <div class="mt-1 p-3 bg-muted rounded-lg font-mono text-sm">Content-Type: application/json</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">trigger type whether for airtime or data</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">Status Description of the request.</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="bg-card border border-border rounded-lg mb-8" x-data="{ tab: 'sample' }">
                ...
                <div x-show="tab==='sample'" class="bg-card border border-border rounded-lg mb-8">
                    ...
                    <div class="p-6">
                        <div class="bg-card p-4 rounded-lg border">
                            <pre class="text-sm font-mono text-card-foreground overflow-x-auto" x-ref="sampleResponse">
{"<span class="text-green-400">subscriberMSISDN"</span>: <span class="text-green-400">"0803xxxxxxx"</span>, <span class="text-green-400">"airtimeThreshold"</span>: <span class="text-green-400">"50"</span>, <span class="text-green-400">"network"</span>: <span class="text-green-400">"MTN"</span>, <span class="text-green-400">"dataThreshold"</span>: <span class="text-green-400">""</span>,
<span class="text-green-400">"thresholdType"</span>: <span class="text-green-400">"airtime"</span>, <span class="text-green-400">"transactionId"</span>: 
<span class="text-green-400">"251068796011729491882"</span>,<span class="text-green-400">"requestType"</span>:<span class="text-green-400">"OneTime/Subscription"</span>, <span class="text-green-400">"event"</span>: <span class="text-green-400">"notification"</span>}
                            </pre>
                        </div>
                    </div>
                </div>
            ...
            <div x-show="tab==='response body'" class="bg-card border border-border rounded-lg mb-8">
                    ...
                    <div class="p-6">
                        <div class="bg-card p-4 rounded-lg border">
                            <pre class="text-sm font-mono text-card-foreground overflow-x-auto" x-ref="sampleResponse">
{<span class="text-green-400">"status"</span>:<span class="text-purple-400">true</span>,<span class="text-green-400">"code"</span>:<span class="text-purple-400">200</span>,<span class="text-green-400">"message"</span>:<span class="text-green-400">"Debited Successful"</span>,<span class="text-green-400">"data"</span>:
{<span class="text-green-400">"isDebited"</span>:<span class="text-purple-400">true</span>,<span class="text-green-400">"transaction_reference"</span>:<span class="text-green-400">"931ATT6715e690775841729488528"</span>,<span class="text-green-400">"amount"</span>:<span class="text-green-400">100"</span>,<span class="text-green-400">"recipient"</span>:<span class="text-green-400">"0803xxxxxxxxxxxx"</span>}}
                            </pre>
                        </div>
                    </div>
                </div>
            ...
            <div x-show="tab==='response'" class="bg-card border border-border rounded-lg mb-8">
                    ...
                    <div class="p-6">
                        <div class="bg-card p-4 rounded-lg border">
                            <pre class="text-sm font-mono text-card-foreground overflow-x-auto" x-ref="sampleResponse">
{"<span class="text-green-400">statusCode"</span>: <span class="text-green-400">"00"</span>, <span class="text-green-400">"statusDescription"</span>: <span class="text-green-400">"Successful"</span>, <span class="text-green-400">"confirmCode"</span>: <span class="text-green-400">"251068796011729491882"</span>, 
<span class="text-green-400">"tranxReference"</span>: <span class="text-green-400">"931ATT6715e690775841729488528"</span>, <span class="text-green-400">"event"</span>: <span class="text-green-400">"update"</span>}
                            </pre>
                        </div>
                    </div>
                </div>
            ...
            <div x-show="tab==='request'" class="bg-card border border-border rounded-lg mb-8">
                    ...
                    <div class="p-6">
                        <div class="bg-card p-4 rounded-lg border">
                            <pre class="text-sm font-mono text-card-foreground overflow-x-auto" x-ref="sampleResponse">
{ <span class="text-green-400">"status"</span>:<span class="text-purple-400">true</span>, <span class="text-green-400">"code"</span>:<span class="text-purple-400">200</span>, <span class="text-green-400">"message"</span>:<span class="text-green-400">"update Successful"</span> }
                            </pre>
                        </div>
                    </div>
                </div>
