                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr class="border-b border-border">
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">Eleven Digits Phone Number. Ex 09062120000</td>
                                </tr>
                                <tr>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-4 text-sm text-muted-foreground">Network operator of msisdn sent in request e.g MTN</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
