        ...
        <main class="flex-1 min-w-0 lg:ml-80">
            <div class="max-w-4xl mx-auto p-6 lg:p-8">
                ...
                <div class="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                    ...
                    <i :class="phoneNumber_lookup_icon + ' text-accent text-sm'"></i>
                ...
                <div class="mb-8">
                    <div class="flex items-center gap-3 mb-4">
                        <h1 class="text-3xl font-bold text-balance">Phone Number Look Up</h1>
                        ...
                        <div class="grid gap-4">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <div class="mt-1 p-3 bg-muted rounded-lg font-mono text-sm"> endpoint
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    ...
                                    <tr class="border-b border-border">
                                        ...
                                        <td class="py-3 px-4 text-sm text-muted-foreground">Eleven Digits Phone Number.
                                            Ex 09062120000
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3 px-4 text-sm text-muted-foreground">Network operator of msisdn
                                            sent in request e.g MTN
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
